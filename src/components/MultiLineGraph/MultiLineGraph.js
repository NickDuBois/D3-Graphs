...
export default class MultiLineGraph extends Component {
    ...
    componentDidMount() {
         ...
         *
         * There are places where you will see a selectAll( [Some element type] ) and it will look
         * like this is going to be returning 0 elements.  This is normally correct, think of it like
         * this, and yes this is VERY generalized:
         *      selectAll() = declaring a collection of a type, while also selecting/adding any of those type to the collection if they exist.
         *
